        ...
        <div className="flex items-center">
            <div className="flex-1">
                <textarea 
                    ...
                    className="w-full text-sm bg-gray-100 rounded-full py-3 px-4 focus:outline-none focus:ring-2 focus:ring-violet-400 resize-none"
                    value={message}
            ...
            <div className="ml-3">
                <button
                    ...
                    type="button"
                    className="bg-violet-600 text-white rounded-full size-10 flex items-center justify-center hover:bg-violet-700 cursor-pointer"
                >
