            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="relative mb-2">
                    ...
                    <input 
                        ...
                        className="text-black text-sm w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-400"
                    />
                </div>
                ...
                <button
                    type="submit"
                    disabled={isFetching}
                    className="w-full flex justify-center items-center bg-violet-600 text-white py-2 rounded-lg hover:bg-violet-700 transition cursor-pointer mt-4"
                >
